...
classdef Eyeballer < handle
    ...
    properties (Access= private, Constant)
        ...
        HALF_TIME_WINDOW_FOR_MANUAL_SACCADE_SEARCH= 50;
    ...
    methods (Access= public)
        function obj= Eyeballer(save_func, raw_eye_data, sampling_rates, manual_saccade_search_func, manual_saccade_search_func_input, saccades_data, main_fig_pos, main_gui_background_color)   
            subjects_nr= numel(raw_eye_data);            
            obj.eye_data= cell(1, subjects_nr);
            obj.sampling_rates = sampling_rates;
            obj.save_func= save_func;
            obj.manual_saccade_search_func= manual_saccade_search_func;  
            ...
            for subject_i= 1:subjects_nr
                ...
                for cond_i= 1:curr_subject_conds_nr                                 
                    ...
                    manual_saccade_search_func_input_unshuffled= [manual_saccade_search_func_input_unshuffled; ...
                        manual_saccade_search_func_input{subject_i}.(curr_subject_conds_names{cond_i})'];                    
    ...
    methods (Access= private)                        
        function plotCurrTrialSaccades(obj)                         
            ...
            set(obj.eyes_x_coords_axes, 'XLim', [0, min(obj.AXES_X_RANGE_SIZE, trial_dur)]);
            set(obj.eyes_y_coords_axes, 'XLim', [0, min(obj.AXES_X_RANGE_SIZE, trial_dur)]);        
            plot(obj.eyes_x_coords_axes, 0:min(obj.AXES_X_RANGE_SIZE, trial_dur), zeros(1,min(obj.AXES_X_RANGE_SIZE, trial_dur) + 1), '--', 'color', [0 0 0]);
            plot(obj.eyes_y_coords_axes, 0:min(obj.AXES_X_RANGE_SIZE, trial_dur), zeros(1,min(obj.AXES_X_RANGE_SIZE, trial_dur) + 1), '--', 'color', [0 0 0]);
            ...
            function [plot_x_ax_left_eye_plot, plot_x_ax_right_eye_plot, plot_y_ax_left_eye_plot, plot_y_ax_right_eye_plot] = plotEyeDataSeg(times)        
                plot_x_ax_left_eye_plot = plot(obj.eyes_x_coords_axes, times, curr_subject_trial_eye_data_struct.left_x(times), 'color', obj.LEFT_EYE_PLOT_COLOR, 'ButtonDownFcn', @obj.eyeDataPlotBtnDownCallback);
                plot_x_ax_right_eye_plot = plot(obj.eyes_x_coords_axes, times, curr_subject_trial_eye_data_struct.right_x(times), 'color', obj.RIGHT_EYE_PLOT_COLOR, 'ButtonDownFcn', @obj.eyeDataPlotBtnDownCallback);            
                plot_y_ax_left_eye_plot = plot(obj.eyes_y_coords_axes, times, curr_subject_trial_eye_data_struct.left_y(times), 'color', obj.LEFT_EYE_PLOT_COLOR, 'ButtonDownFcn', @obj.eyeDataPlotBtnDownCallback);                            
                plot_y_ax_right_eye_plot = plot(obj.eyes_y_coords_axes, times, curr_subject_trial_eye_data_struct.right_y(times), 'color', obj.RIGHT_EYE_PLOT_COLOR, 'ButtonDownFcn', @obj.eyeDataPlotBtnDownCallback);                           
            end
            ...
            function [blinks_on_x_plot, blinks_on_y_plot] = plotBlinkSeg(times)
                ...
                blinks_on_x_plot = plot(obj.eyes_x_coords_axes, [times(1), times(end)], [xAxisLeftEyeStartY, xAxisLeftEyeEndY], 'k:', 'markersize', 5);
                plot(obj.eyes_x_coords_axes, [times(1), times(end)], [xAxisRightEyeStartY, xAxisRightEyeEndY], 'k:', 'markersize', 5);
                blinks_on_y_plot = plot(obj.eyes_y_coords_axes, [times(1), times(end)], [yAxisLeftEyeStartY, yAxisLeftEyeEndY], 'k:', 'markersize', 5);                
                plot(obj.eyes_y_coords_axes, [times(1), times(end)], [yAxisRightEyeStartY, yAxisRightEyeEndY], 'k:', 'markersize', 5);                
            end                        
        end                                
        ...
        function saccade_plots_hs= plotSaccade(obj, saccade_times, plot_color)
            ...
            function p= plotEdgeMark(time, eye_data)
                p= zeros(1,4);                
                p([1,2])= plot(obj.eyes_x_coords_axes, time, [eye_data(1), eye_data(2)], ...
                    'LineStyle', 'none', ...
                    'marker', 'o', ...
                ...
                p([3,4])= plot(obj.eyes_y_coords_axes, time, [eye_data(3), eye_data(4)], ...
                    'LineStyle', 'none', ...
                    'marker', 'o', ...
                    'markerSize', obj.SACCADE_MARKERS_SIZE, ...
                    'MarkerEdgeColor', plot_color, ...
            ...
            function p= plotEyeDataOnSaccadeSeg(saccade_seg_times, eye_data)
                p= zeros(1,4);     
                p([1,2])= plot(obj.eyes_x_coords_axes, [saccade_seg_times; saccade_seg_times]', eye_data([1,2],:)', ...
                    'LineStyle', '-', ...
                    'LineWidth', 2, ...
                    'Color', plot_color, ...
                    'ButtonDownFcn', @obj.saccadePlotBtnDownCallback);
                
                p([3,4])= plot(obj.eyes_y_coords_axes, [saccade_seg_times; saccade_seg_times]', eye_data([3,4],:)', ...
                    'LineStyle', '-', ...
                    'LineWidth', 2, ...
                    'Color', plot_color, ...
                    'ButtonDownFcn', @obj.saccadePlotBtnDownCallback);
...
%             save('zoom_out_icon_cdata.mat', 'zoom_out_icon_cdata');            
        ...
        function autoExtractSaccadesWithNewParamsPressedCallback(obj, ~, ~)
            ...
            obj.auto_extraction_amp_lim_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2002', ...
                ...
                'callback', @Eyeballer.newExtractionParamEditedCallback);
    ...
    methods (Access= private, Static)
        function newExtractionParamEditedCallback(hObject, ~)
            input= get(hObject,'string');                        
            if Eyeballer.isStrAValidPositiveInteger(input)
