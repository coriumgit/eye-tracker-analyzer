...
classdef SaccadesExtractor < handle
    ...
    methods (Access= public)       
        ...
        function [eye_data_struct, saccades_struct, eyeballing_stats]= extractSaccadesByEngbert(obj, vel_calc_type, vel_threshold, amp_lim, amp_low_lim, saccade_dur_min, frequency_max, filter_bandpass, perform_eyeballing, etas_save_folder, progress_contribution, progress_screen)                           
...
%                             end
                ...
                if perform_eyeballing                    
                    eyeballer= Eyeballer(@eyeballer_save_func, raw_eye_data_for_eyeballer, obj.sampling_rates, ...
                                         @SaccadesExtractor.findSaccadeForcefullyOnDefinedTimesByEngbert, manual_saccades_search_func_params_for_eyeballer, ...
                                         saccades_struct, obj.eyeballer_main_gui_pos, obj.EYEBALLER_MAIN_GUI_BACKGROUND_COLOR);
            ...
            function eyeballer_save_func(saccades_struct)
                for saved_subject_i= 1:numel(obj.subjects_etas)                                                       
                    ...
                    obj.subjects_etas{saved_subject_i}.save(etas_save_folder);
                end
            end
        end                
    end                
